...
export interface CfnTransitGatewayMulticastDomainAssociationProps {
    /**
     * `AWS::EC2::TransitGatewayMulticastDomainAssociation.State`.
     *
     * @external
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewaymulticastdomainassociation.html#cfn-ec2-transitgatewaymulticastdomainassociation-state
     */
    readonly state?: string;
    /**
...
export interface CfnTransitGatewayMulticastGroupMemberProps {
    ...
    readonly networkInterfaceId?: string;
    /**
     * `AWS::EC2::TransitGatewayMulticastGroupMember.TransitGatewayAttachmentId`.
     *
     * @external
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewaymulticastgroupmember.html#cfn-ec2-transitgatewaymulticastgroupmember-transitgatewayattachmentid
     */
    readonly transitGatewayAttachmentId?: string;
    /**
...
export interface CfnTransitGatewayMulticastGroupSourceProps {
    ...
    readonly networkInterfaceId?: string;
    /**
     * `AWS::EC2::TransitGatewayMulticastGroupSource.TransitGatewayAttachmentId`.
     *
     * @external
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewaymulticastgroupsource.html#cfn-ec2-transitgatewaymulticastgroupsource-transitgatewayattachmentid
     */
    readonly transitGatewayAttachmentId?: string;
    /**
